...
export const en = {
  ...
  // Suggest an edit (T-083). One form, two framings: an operator is editing
  // their own listing, everyone else is proposing a correction a moderator
  // reads first.
  'suggest.entry': 'Something wrong? Suggest a change',
  'suggest.title': 'Suggest a change',
  'suggest.title.owner': 'Edit business info',
  'suggest.note.review': 'A moderator reviews changes before they go live. Thanks for helping keep this accurate.',
  'suggest.note.owner': 'You run this venue, so your changes go live right away.',
  'suggest.submit': 'Send suggestion',
  'suggest.save': 'Save',
  'suggest.placeholder.empty': 'Empty',
  'suggest.queued.title': 'Thanks!',
  'suggest.queued.body': 'We sent your suggestion for review. If it checks out, it will show up here soon.',
  'suggest.field.name': 'Name',
  'suggest.field.address': 'Street',
  'suggest.field.address2': 'Address line 2',
  'suggest.field.city': 'City',
  'suggest.field.region': 'Region',
  'suggest.field.postalCode': 'Postal code',
  'suggest.field.country': 'Country',
  'suggest.field.cuisine': 'Cuisine',
  'suggest.field.priceRange': 'Price range',
  ...
  'suggest.note.placeholder': 'e.g. this place closed down, or the pin is on the wrong side of the street',
  'suggest.note.hint': 'Tell us in your own words. A moderator reads it.',
  ...
  'suggest.venue.empty.title': 'Nothing pending',
  'suggest.venue.empty.body': 'No one has suggested a change to your venues right now.',
  'suggest.venue.empty.value': '(empty)',
  ...
  'editProfile.countryPlaceholder': 'Choose a country',
  'editProfile.countryHint': 'Country only — shown on your profile when it’s public.',
