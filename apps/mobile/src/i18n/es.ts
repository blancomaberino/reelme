...
export const es: Record<MessageKey, string> = {
  ...
  // Tonight (T-158) — ver en.ts para por qué la línea de respuesta reemplaza a
  // las etiquetas de los controles.
  'tabs.tonight': 'Esta noche',
  'tonight.title': 'Esta noche',
  'tonight.answer.open': '{{count}} lugares abiertos a menos de {{km}} km',
  'tonight.answer.open_one': '{{count}} lugar abierto a menos de {{km}} km',
  'tonight.answer.open_other': '{{count}} lugares abiertos a menos de {{km}} km',
  'tonight.answer.any': '{{count}} lugares a menos de {{km}} km',
  'tonight.answer.any_one': '{{count}} lugar a menos de {{km}} km',
  'tonight.answer.any_other': '{{count}} lugares a menos de {{km}} km',
  'tonight.answer.locating': 'Buscando dónde estás',
  'tonight.answer.looking': 'Mirando cerca tuyo',
  'tonight.openNow': 'Abierto ahora',
  'tonight.zone': '{{km}} km',
  'tonight.dish.placeholder': '¿Qué se te antoja?',
  'tonight.dish.label': 'Plato',
  'tonight.needsLocation': 'Esta noche necesita tu ubicación para encontrar lugares cerca tuyo.',
  'tonight.empty': 'Nada coincide todavía. Probá una zona más amplia, o apagá “Abierto ahora”.',
  'tabs.map': 'Mapa',
  ...
  'place.openNow': 'Abierto ahora',
  'place.openUntil': 'Abierto · cierra {{time}}',
  'place.closedNow': 'Cerrado',
  'place.closedUntil': 'Cerrado · abre {{time}}',
  ...
  // Sugerir un cambio (T-083). Un solo formulario, dos lecturas: quien opera el
  // local edita su propia ficha; el resto propone una corrección que un
  // moderador revisa antes.
  'suggest.entry': '¿Hay algo mal? Sugerí un cambio',
  'suggest.title': 'Sugerir un cambio',
  'suggest.title.owner': 'Editar la información',
  'suggest.note.review': 'Un moderador revisa los cambios antes de publicarlos. Gracias por ayudar a mantener esto al día.',
  'suggest.note.owner': 'Vos operás este local, así que tus cambios se publican al instante.',
  'suggest.submit': 'Enviar sugerencia',
  'suggest.save': 'Guardar',
  'suggest.placeholder.empty': 'Vacío',
  'suggest.queued.title': '¡Gracias!',
  'suggest.queued.body': 'Enviamos tu sugerencia a revisión. Si todo cierra, va a aparecer acá en breve.',
  'suggest.field.name': 'Nombre',
  'suggest.field.address': 'Calle',
  'suggest.field.address2': 'Dirección (línea 2)',
  'suggest.field.city': 'Ciudad',
  'suggest.field.region': 'Región',
  'suggest.field.postalCode': 'Código postal',
  'suggest.field.country': 'País',
  'suggest.field.cuisine': 'Cocina',
  'suggest.field.priceRange': 'Rango de precio',
  'suggest.field.phone': 'Teléfono',
  ...
  'suggest.venue.intro': 'Lo que la gente propone sobre tus locales. Un moderador revisa cada uno.',
  'suggest.venue.pending': 'Pendiente de revisión',
  'suggest.venue.empty.title': 'No hay nada pendiente',
  'suggest.venue.empty.body': 'Ahora mismo nadie sugirió cambios en tus locales.',
  'suggest.venue.empty.value': '(vacío)',
  ...
  'editProfile.countryPlaceholder': 'Elegí un país',
  'editProfile.countryHint': 'Solo el país — se muestra en tu perfil cuando es público.',
